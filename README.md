...
```
CarStudio/
├── CarStudioAI/    # Aplicação principal (Next.js - produção)
├── demo/           # MVP de demonstração (versão inicial)
├── docs/           # Documentação geral do projeto
└── sql/            # Migrações SQL do banco de dados
```
...
### Estrutura da Aplicação (`CarStudioAI/`)
...
Veja `CarStudioAI/.env.example` para lista completa. Principais:
...
1. Push para GitHub
2. Importe projeto na Vercel apontando para a pasta `CarStudioAI/`
